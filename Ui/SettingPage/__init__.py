...
class SettingWidget(ScrollArea):
    ...
    def initialize(self, parent):
        ...
        SettingPageStyleSheet.SETTING_PAGE.apply(self)
...
class SettingWidgetClassCreator(AbstractCreator, ABC):
    ...
    targets = (CreateTargetInfo("Ui.SettingPage", "SettingWidget"),)

    # 静态方法available()，用于检查模块"SettingWidget"是否存在，返回值为布尔型。
    @staticmethod
    def available() -> bool:
        return exists_module("Ui.SettingPage")
